...
export const POLICY_NAMES = ['open', 'bidder-only-me', 'requester-only-me', 'bidder-mutuals', 'requester-mutuals', 'bidder-tangled-vouch', 'requester-tangled-vouch', 'under-4-cpus', 'bid-payload'];
